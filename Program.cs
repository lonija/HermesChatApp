...
namespace HermesChat.Web
{
    public static class Program
    {
        public static void Main(string[] args)
        {
            ...
            var connectionString = builder.Configuration.GetSection("HermesChatAzureDb").Value;
                //builder.Configuration.GetConnectionString("HermesChatContextConnection") ?? throw new InvalidOperationException("Connection string 'HermesChatContextConnection' not found.");
            // Logger below
